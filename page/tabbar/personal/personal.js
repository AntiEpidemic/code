...
Page({
  ...
  data: {
    ...
    openid:'',
    dataReady: false,
    array:['苏康码','随申码','杭州健康码','国家健康码'],
    
    index:0,
    pic_src:'/image/suzhou_pic.jpg',
    icon_src: '/image/suzhou_icon.jpg',
  },

  bindPickerChange(e) {
    var icon_array = ['suzhou_icon.jpg','shanghai_icon.jpg','hangzhou_icon.jpg','guojia_icon.jpg'];
    var pic_array = ['suzhou_pic.jpg','shanghai_pic.jpg','hangzhou_pic.jpg','guojia_pic.jpg'];
    console.log('picker发送选择改变，携带值为', e.detail.value);
    this.setData({
      index: e.detail.value,
    });
    var iconImag = '/image/' + icon_array[e.detail.value]
    var picImag = '/image/' + pic_array[e.detail.value]
    this.setData({
      icon_src: iconImag
    })
    this.setData({
  ...
  more: function(){
    wx.showModal({
      title: '途经详情',
      content: '-----2020-09-10 江苏南京----------2020-08-01 江苏苏州----------2020-06-01 山西大同-----',
      confirmText: '分享',
    })
